...
Vue.component("purple_hero_component_1722501915", {
    template: `
    <section id="hero-section-container" class="bg-gradient-to-br from-pink-500 via-purple-600 to-magenta-700">
    <div id="section-container" class="relative max-w-6xl mx-auto px-4 sm:px-6 backdrop-blur-lg bg-white/10 rounded-xl shadow-xl">
        <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
            ...
            <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative; z-index: 1">
                        ...
                        <a id="announcement-link" class="flex-1 btn-sm py-0.5 transition duration-150 ease-in-out group relative before:absolute before:inset-0 before:rounded-full before:pointer-events-none shadow text-white hover:text-pink-200 before:bg-purple-800/50" 
                           ...
                           style="background: linear-gradient(to right, rgba(255,255,255,0.1), rgba(255,255,255,0.2)) padding-box, linear-gradient(to right, rgba(255,255,255,0.4), rgba(255,255,255,0.1)) border-box;">
                            <span id="announcement-link-text" class="relative inline-flex items-center">
                                Introducing our new blockchain data analysis app! 
                ...
                <div class="flex" id="hero-text-container">
                    <h1 id="hero-text" class="h1 text-transparent bg-clip-text bg-gradient-to-r from-pink-200 via-purple-300 to-magenta-200 pb-4 text-5xl font-extrabold" data-aos="fade-down">Gain Insights into Blockchain Data</h1>
                </div>
                <div class="flex" id="sub-hero-text-container">
                    <p id="sub-hero-text" class="flex-1 text-lg mb-8 text-white/80" data-aos="fade-down" data-aos-delay="200">Our cutting-edge app provides real-time analytics and visualizations for blockchain networks, helping you uncover valuable insights.</p>
                </div>
